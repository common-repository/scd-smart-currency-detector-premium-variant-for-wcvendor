<?php
/*
  Plugin Name: SCM - Smart Currency Manager - Premium Variant for WcVendor
...
register_activation_hook(__FILE__, 'scd_wcv_plugin_install');

function scd_wcv_plugin_install(){
    if(!get_option('scd_wcv_first_install_date')){
        update_option('scd_wcv_first_install_date',new DateTime('now'));
    }   
}


function scd_wcv_features_date(){
	...
	if(get_option('scd_wcv_first_install_date')){
		...
		if(scds_check_license_active()){
             ...
             $fist_install_date = get_option('scd_wcv_first_install_date');
             $reste = 0;
             $text = "";
			 ...
			 if($reste > 6*24*60 && $reste <= 7*24*60){
				$text = "<span style='color:black;'>You have less than 7 days to enjoy  free SCM Premium for WC-Vendor. Please activate your license to enjoy and to get automatic updates and premium support! Click <a href='". admin_url('admin.php?page=scd_options_page&tab=license') ."' >here</a> to activate or update your license key. </span>"  ; 
            }else if($reste > 5*24*60 && $reste <= 6*24*60){
				$text = "<span style='color:black;'>You have less than 6 days to enjoy  free SCM Premium for WC-Vendor. Please activate your license to enjoy and to get automatic updates and premium support!  Click <a href='". admin_url('admin.php?page=scd_options_page&tab=license') ."' >here</a> to activate or update your license key.</span>"  ;  
            }else if($reste > 4*24*60 && $reste == 5*24*60){
				$text = "<span style='color:black;'>You have less than 5 days to enjoy  free SCM Premium for WC-Vendor. Please activate your license to enjoy and to get automatic updates and premium support! Click <a href='". admin_url('admin.php?page=scd_options_page&tab=license') ."' >here</a> to activate or update your license key.</span>"  ;  
            }else if($reste > 3*24*60 && $reste <= 4*24*60){
				$text = "<span style='color:black;'>You have less than 4 days to enjoy  free SCM Premium for WC-Vendor. Please activate your license to enjoy and to get automatic updates and premium support! Click <a href='". admin_url('admin.php?page=scd_options_page&tab=license') ."' >here</a> to activate or update your license key.</span>"  ;  
            }else if($reste > 2*24*60 && $reste <= 3*24*60){
				$text = "<span style='color:black;'>You have less than 3 days to enjoy  free SCM Premium for WC-Vendor. Please activate your license to enjoy and to get automatic updates and premium support! Click <a href='". admin_url('admin.php?page=scd_options_page&tab=license') ."' >here</a> to activate or update your license key.</span>"  ;  
            }else if($reste > 1*24*60 && $reste <= 2*24*60){
				$text = "<span style='color:black;'>You have less than 2 days to enjoy  free SCM Premium for WC-Vendor. Please activate your license to enjoy and to get automatic updates and premium support! Click <a href='". admin_url('admin.php?page=scd_options_page&tab=license') ."' >here</a> to activate or update your license key.</span>"  ;  
            }else if( $reste > 0 && $reste <= 1*24*60){
				$text = "<span style='color:black;'>You have less than 1 day to enjoy  free SCM Premium for WC-Vendor. Please activate your license to enjoy and to get automatic updates and premium support! Click <a href='". admin_url('admin.php?page=scd_options_page&tab=license') ."' >here</a> to activate or update your license key.</span>"  ; 
            }else if($reste < 0){
				$text = "<span style='color:black;'>The SCM-Multivendors for wc-vendor license key has not been activated or has expired, so you will be unable to get automatic updates and premium support! Click <a href='". admin_url('admin.php?page=scd_options_page&tab=license') ."' >here</a> to activate or update your license key.</span>"  ; 
			}
		}
	}
...
if(!is_plugin_active('scd-smart-currency-detector/index.php')){
    echo '<h3 style="color:red;">SCM Multivendors for Wc vendors require scm-smart-currency-manager before use, please <a target="__blank" href="https://wordpress.org/plugins/scd-smart-currency-detector/"> download and install it here</a><h3>';    
}
}
