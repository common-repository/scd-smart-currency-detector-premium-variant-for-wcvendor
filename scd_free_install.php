...
function scd_free_dashboard_setup()
{
        ...
        set_current_screen(); ?>
            ...
            <html <?php language_attributes(); ?>>
                    <head>
                            ...
                            <title><?php esc_html_e('SCM &rsaquo; Setup Wizard', 'scd_wcv_marketplace'); ?></title>
                    ...
                    <body class="scd-setup wp-core-ui">
                            <h1 id="wc-logo"><a href="http://gajelabs.com/"><img src="<?php echo $scd_free_icon; ?>" alt="SCM" /><span>SMART CURRENCY DETECTOR</span></a></h1>
                            <div class="scd-install-scdFree">
                                    <p><?php _e(' This variant need <strong style="color:red; font-weight: bold;"> Smart Currency Manager </strong>to active.', 'scd_wcv_marketplace'); ?></p>
                                    <form method="post" action="" name="scd_install_scdFree">
                                            <?php submit_button(__('Install SCM Free', 'scd_wcv_marketplace'), 'primary', 'scd_free_install'); ?>
	...
	function cancel_scd_free(){
          ...
          deactivate_plugins( '/scd-smart-currency-detector-variant-for-wcv/index.php', true);
